...
public class Animation {
	...
	public void drawAnimation(Graphics g, double x, double y, int width, int height, int scaledWidth, int scaledHeight){
		g.drawImage(currentImg, (int)x, (int)y, (int)x + scaledWidth, (int)y + scaledHeight, 0, 0, width, height, null);
	}
